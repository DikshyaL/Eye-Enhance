...
export default function Services() {
  ...
  const servicesData = [
    ...
    { title: "Lash Lift (Upper Lashes) and lower Lash Tint", description: "Transform your lashes with our lash lift service for a beautiful curl and lift. This treatment enhances your natural lashes, making them appear fuller and more defined.", Price: "$95" }, 
