export default function Location(){
  return (
    <div className='flex flex-col justify-center items-center p-4 space-y-6 m-auto bg-white'>
        ...
        <div className='flex flex-col md:flex-row justify-between md:space-x-10 space-y-8 md:w-3/4 items-center justify-center '>
            <div className='bg-fuchsia-200 rounded-2xl p-4 mt-4 '>
              <div className='p-6 rounded-2xl bg-fuchsia-100 w-64'>
                <h2 className='text-xl font-custom mt-2'>Location</h2>
            ...
            <div className=' bg-fuchsia-200 rounded-2xl p-4 '>
              <div className='p-6 rounded-2xl bg-fuchsia-100 w-64'>
